                ...
                <div style={{ width: "100%" }}>
                  ...
                  <Button.Group hasAddons>
                    <Button style={{ width: "33%", border:"none"}}>
                      <span id="smallButton" style={{ fontWeight: "500", border: "1px solid black", borderRadius: "4px", padding: '6px', paddingTop: '3px', paddingBottom: '3px'}}
                    ...
                    <Button style={{ width: "33%", border:"none"}}>
                    <span id="mediumButton" style={{ fontWeight: "500", border: "1px solid black", borderRadius: "4px", padding: '6px', paddingTop: '3px', paddingBottom: '3px' }}
                    ...
                    <Button style={{ width: "33%", border:"none" }}>
                    <span id="largeButton" style={{ fontWeight: "500", border: "1px solid black", borderRadius: "4px", padding: '6px', paddingTop: '3px', paddingBottom: '3px' }}
